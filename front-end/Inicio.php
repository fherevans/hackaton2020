		...
		<div id="wrapper">
			...
			<div id="c_w" class="border" >
				<div id="cursos" class="border">
					...
					<?php 
						$connection = pg_connect("dbname=hackaton user=edith password=");
						$result = pg_query($connection, "SELECT nombre_materia FROM public.inscribir WHERE (user_alumno = 'Edith');");
						$total_materia = count($result);
						$paginas = count($result) / 3;
					?>
						   ...
						   <?php 
								if ($result) {
									...
									while ($row = pg_fetch_row($result)) {
									  echo '<div id="div'.$x.'" class="col-sm-3 border" style="margin-right: 40px; padding: 0;"> 
										    	<div> 
