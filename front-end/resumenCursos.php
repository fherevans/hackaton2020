		...
		<div id="wrapper">
			<div id="b_w" class="border">
				<div id="bitacora" class="border">
					<div class="card-body">
						<h3 class="card-header text-center font-weight-bold text-uppercase py-4">Actividades<h3>
							<h6 class="card-header font-weight-bold text-uppercase py-4">Sumas<h6>
							<img src="./imagenes/sumas.png" alt="Sumas con saltos" width="300" height="300">
					</div>
				</div>
			</div>
		</div>
